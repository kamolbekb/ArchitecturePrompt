    ...
    public partial class MigrationUntilProd : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_LessonShifts_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonShifts_Shifts_ShiftId",
                        column: x => x.ShiftId,
                        principalTable: "Shifts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiaryRecords_Diaries_DiaryId",
                        column: x => x.DiaryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonShifts_LessonId",
                table: "LessonShifts",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonShifts_ShiftId",
                table: "LessonShifts",
                column: "ShiftId");
